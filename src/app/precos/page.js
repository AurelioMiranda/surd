    ...
    <div className={styles.precosContainer987} style={{marginTop: '20px'}}>
      <section className={styles.precosSection987}>
        ...
        <div className={styles.priceImageContainer987}>
          ...
          <p className={styles.imageCaption987}>Figura 5 - Preço por unidade dos stickers para vidro quadrangulares.</p>
        </div>
        ...
        <div className={styles.priceImageContainer987}>
          ...
          <p className={styles.imageCaption987}>Figura 6 - Preço por unidade das tatuagens temporárias.</p>
        </div>
        ...
        <div className={styles.priceImageContainer987}>
          ...
          <p className={styles.imageCaption987}>Figura 7 - Portes de envio.</p>
        </div>

        <div className={styles.priceImageContainer987}>
          <img src="treatment-prices.jpeg" alt="Treatment prices" className={styles.precoImage987} />
          <p className={styles.imageCaption987}>Figura 8 - Preço do tratamento de imagem, em função da quantidade encomendada.</p>
        </div>
