...
const stickerPrices = {
  circular: {
    "3X3 (vinil)": [2.55, 1.47, 0.84, 0.62, 0.52, 0.44],
    "5X5 (vinil)": [3.83, 2.12, 1.16, 0.84, 0.68, 0.57],
    "7X7 (vinil)": [4.90, 2.65, 1.43, 1.02, 0.81, 0.68],
    "10X10 (vinil)": [5.90, 3.15, 1.62, 1.18, 0.94, 0.78],
  },
  custom: {
    "3X3 (vinil)": [2.55, 1.47, 0.84, 0.62, 0.52, 0.44],
    "5X5 (vinil)": [3.83, 2.12, 1.16, 0.84, 0.68, 0.57],
    "7X7 (papel)": [3.98, 2.44, 1.70, 1.36, 1.20, 0.97],
    "10X10 (papel)": [4.49, 2.78, 2.04, 1.70, 1.51, 1.38],
  },
  square: {
    "3X3 (vinil)": [2.09, 1.24, 0.72, 0.55, 0.46, 0.40],
    "5X5 (vinil)": [3.37, 1.89, 1.04, 0.76, 0.62, 0.53],
    "7X7 (vinil)": [5.10, 2.75, 1.48, 1.05, 0.86, 0.70],
    "10X10 (vinil)": [6.70, 3.55, 1.88, 1.32, 1.06, 0.86],
    "8,5X5,5 (vinil)": [3.97, 2.19, 1.19, 0.86, 0.70, 0.59],
    "11X9 (vinil)": [5.45, 2.93, 1.56, 1.32, 1.04, 0.86],
  },
  glass: {
    "20x20 (vinil)": [15.50, 12.50, 11.17, 10.25, 8.98, 4.74],
    "40x40 (vinil)": [19.50, 16.00, 13.17, 11.75, 10.50, 8.00],
    "60x60 (vinil)": [25.50, 21.00, 18.17, 15.75, 13.50, 10.00],
    "90x90 (vinil)": [31.50, 27.00, 24.17, 20.50, 19.50, 14.00],
    "120x120 (vinil)": [41.50, 35.00, 30.17, 25.75, 21.50, 16.00],
  },
  instaStickers: {
...
const stickerQuantities = {
  circular: {
    "3X3 (vinil)": [5, 10, 20, 30, 40, 50],
    "5X5 (vinil)": [5, 10, 20, 30, 40, 50],
    "7X7 (vinil)": [5, 10, 20, 30, 40, 50],
    "10X10 (vinil)": [5, 10, 20, 30, 40, 50],
  },
  custom: {
    "3X3 (vinil)": [5, 10, 20, 30, 40, 50],
    "5X5 (vinil)": [5, 10, 20, 30, 40, 50],
    "7X7 (papel)": [5, 10, 20, 30, 40, 50],
    "10X10 (papel)": [5, 10, 20, 30, 40, 50],
  },
  square: {
    "3X3 (vinil)": [5, 10, 20, 30, 40, 50],
    "5X5 (vinil)": [5, 10, 20, 30, 40, 50],
    "7X7 (vinil)": [5, 10, 20, 30, 40, 50],
    "10X10 (vinil)": [5, 10, 20, 30, 40, 50],
    "8,5X5,5 (vinil)": [5, 10, 20, 30, 40, 50],
    "11X9 (vinil)": [5, 10, 20, 30, 40, 50],
  },
  glass: {
    "20x20 (vinil)": [1, 2, 3, 4, 5, 10],
    "40x40 (vinil)": [1, 2, 3, 4, 5, 10],
    "60x60 (vinil)": [1, 2, 3, 4, 5, 10],
    "90x90 (vinil)": [1, 2, 3, 4, 5, 10],
    "120x120 (vinil)": [1, 2, 3, 4, 5, 10],
  },
  instaStickers: {
